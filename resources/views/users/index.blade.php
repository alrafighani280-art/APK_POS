                ...
                <form action="{{ route('admin.users') }}" method="GET">
                    <div class="row g-2 justify-content-between align-items-center">
                        ...
                        <div class="col-12 col-md-auto text-md-end">
                            <a href="{{ route('admin.users.create') }}" class="btn btn-primary fw-semibold px-3 py-2 rounded-3 d-inline-flex align-items-center gap-2" style="background-color: #0B6477; border-color: #0B6477;">
