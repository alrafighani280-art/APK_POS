...
<div class="container-fluid py-3 py-md-4 px-3 px-lg-4">

    <!-- Header Section -->
    <div class="d-flex flex-column flex-sm-row justify-content-between align-items-sm-center mb-4 pb-3 border-bottom gap-2">
        <div>
            <h2 class="fw-bold text-dark mb-1 fs-3 fs-md-2">Ringkasan Hari Ini</h2>
    ...
    <div class="mb-4 mb-md-5">
        <h5 class="fw-bold text-secondary mb-3 fs-6 fs-md-5">Statistik Transaksi & Pembayaran</h5>
        <div class="row g-2 g-md-3">
            
            <!-- Total Penjualan -->
            <div class="col-12 col-sm-6 col-xl-3">
                <div class="card stat-card shadow-sm p-3 bg-white h-100 border-0">
                    <div class="d-flex align-items-center justify-content-between">
                        <div>
                            <span class="text-muted small fw-semibold d-block">Total Penjualan</span>
                            <h4 class="fw-bold text-dark mt-1 mb-0 fs-5 fs-md-4">
                                Rp {{ number_format($ringkasan['total_penjualan'] ?? $ringkasan['total_pembayaran'] ?? 0, 0, ',', '.') }}
                            </h4>
                        </div>
                        <div class="icon-box bg-primary bg-opacity-10 text-primary p-2 p-md-3 rounded-circle">
            ...
            <div class="col-12 col-sm-6 col-xl-3">
                <div class="card stat-card shadow-sm p-3 bg-white h-100 border-0">
                    <div class="d-flex align-items-center justify-content-between">
                        <div>
                            <span class="text-muted small fw-semibold d-block">Jumlah Transaksi</span>
                            <h4 class="fw-bold text-dark mt-1 mb-0 fs-5 fs-md-4">
                                {{ $ringkasan['total_transaksi'] ?? $ringkasan['jumlah_transaksi'] ?? 0 }}
                            </h4>
                        </div>
                        <div class="icon-box bg-info bg-opacity-10 text-info p-2 p-md-3 rounded-circle">
            ...
            <div class="col-12 col-sm-6 col-xl-3">
                <div class="card stat-card shadow-sm p-3 bg-white h-100 border-0">
                    <div class="d-flex align-items-center justify-content-between">
                        <div>
                            <span class="text-muted small fw-semibold d-block">Total Tunai</span>
                            <h4 class="fw-bold text-dark mt-1 mb-0 fs-5 fs-md-4">
                                Rp {{ number_format($ringkasan['total_cash'] ?? $ringkasan['total_tunai'] ?? 0, 0, ',', '.') }}
                            </h4>
                        </div>
                        <div class="icon-box bg-success bg-opacity-10 text-success p-2 p-md-3 rounded-circle">
            ...
            <div class="col-12 col-sm-6 col-xl-3">
                <div class="card stat-card shadow-sm p-3 bg-white h-100 border-0">
                    <div class="d-flex align-items-center justify-content-between">
                        <div>
                            <span class="text-muted small fw-semibold d-block">Total Non-Tunai</span>
                            <h4 class="fw-bold text-dark mt-1 mb-0 fs-5 fs-md-4">
                                Rp {{ number_format($ringkasan['total_non_tunai'] ?? $ringkasan['total_qris'] ?? 0, 0, ',', '.') }}
                            </h4>
                        </div>
                        <div class="icon-box bg-warning bg-opacity-10 text-warning p-2 p-md-3 rounded-circle">
    ...
    <div class="mb-4 mb-md-5">
        <div class="d-flex flex-row justify-content-between align-items-center mb-3">
            <h5 class="fw-bold text-secondary mb-0 fs-6 fs-md-5">Status Inventaris Kritis</h5>
                            ...
                            <table class="table table-custom align-middle mb-0 text-nowrap">
                                <thead>
                                    <tr>
                                        ...
                                        <th>Nama Produk</th>
                                        <th class="text-center pe-3">Sisa Stok</th>
                                    </tr>
                                </thead>
                                <tbody>
    ...
    <div class="mb-4">
        <h5 class="fw-bold text-secondary mb-3 fs-6 fs-md-5">Produk Terlaris</h5>
                    ...
                    <table class="table table-custom align-middle mb-0 text-nowrap">
                        ...
                        <tbody>
                            @forelse ($produkTerlaris as $produk)
                                <tr>
                                    <td class="ps-3 fw-semibold text-dark text-truncate" style="max-width: 250px;">
                                        {{ $produk->nama ?? $produk->nama_produk }}
                                    </td>
                                    <td>
